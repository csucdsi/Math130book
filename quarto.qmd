...
To convert your work into a professional looking PDF, or to write math symbols in your homework, or you need a typesetting program called $\LaTeX$ (pronounced "lay-tek" or "lah-tex"). It's a super neat program,
...
version of $\LaTeX$. This will let us write math equations in Markdown/Quarto, and create nice PDF's of your work.
...
Test it out now by rendering ... <thing> to PDF by clicking on the down arrow next to "Render" and choosing "PDF". 
> FIXME
