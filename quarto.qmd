...
**Visual vs Source mode** RStudio’s **Visual** editor offers a [WYSIWYM](https://en.wikipedia.org/wiki/WYSIWYM) [What You See Is What You Mean]{.aside} authoring experience for markdown formatting of text. Each view has it's benefits and drawbacks, and which you choose to use is purely a matter of personal preference.
...
[See more basic syntax of Markdown at <a href="https://markdownguide.offshoot.io/basic-syntax/"> https://markdownguide.offshoot.io/basic-syntax/</a>]{.aside}
