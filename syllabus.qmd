...
* **Course Website:** [math130.netlify.app](math130.netlify.app)
...
* **Discord Server:** [https://discord.gg/ck497bJty5](https://discord.gg/ck497bJty5)


|                        |        Section 01       |
|:-----------------------|:-----------------------:|
| **Meeting Days**       | 01/21/26 - 02/20/26     |
| **Meeting Times**      | MWF 9:00 - 9:50 am      |
| **Meeting Location**   | Holt Hall 113           |
...
<!-- updateme -->
<!---
For the first five weeks of the semester (1/25/2025 - 9/26/2025), my office hours will be in the [Meriam Library Innovation Lab](https://library.csuchico.edu/innovation-lab):
--->

* Mondays: 3-5pm [Meriam Library Innovation Lab](https://library.csuchico.edu/innovation-lab)
* Tuesdays: 1-2pm over Zoom. Link in Canvas
* Wednesdays: 2-3pm Holt 202

You can always reach me in the Math 130 channel of our official course communication platform [Discord](https://discord.gg/ck497bJty5). See below for details on how to connect. 

If none of those times work for you, please use my booking link in Canvas to find a time that works for both of us. <!---email me so that we can find a time that works for us both: xxx@csuchico.edu--->
...
<!-- There are no set meeting times, but assignments still have due dates. Lectures are all pre-recorded and linked from the class website. Students work through the material and complete assignments at their own pace.  -->
...
This is an interactive in person class. We will go over the learning material together as a class. You will follow along on your laptop, filling out notes and working on examples and homework. 

<!--- See Canvas for your specific section for more details. --->

## Canvas Usage
<!-- updateme -->

Generally speaking, this course website will be used instead of
Canvas.  A link in Canvas leads to this website.  

<!-- Canvas will only be used for announcements and friendly reminders to the class. --->

Canvas will be used to submit assignments, and your gradebook.
...
Schedule and info found at [https://datascience.csuchico.edu/communitycoding](https://datascience.csuchico.edu/communitycoding)
...
* Week 1 (Lessons 1-3)
    ...
    - Conducting reproducible research with Quarto
* Week 2 (Lessons 4-5)
    - How to use functions to get things done in data frames
    - Working with factors
* Week 3 (Lessons 6-7)
    - Basic data visualizations using `ggplot2` and friends
    - Efficient data processing and Aggregation with `dplyr`
* Week 4 (Lessons 8-9)
    - Importing data into R from external files
    - Next level plotting enhancements
...
If you have your own PC/Mac/*nix computer, you are advised to install R and R Studio on your personal computer. That way you can take what you've learned in this class and apply it to other classes. Both are free. Walk through installation instructions can be found on the course website: [https://math130.netlify.app/setup_tools](https://math130.netlify.app/setup_tools)

<!--updateme ---> 

* R version 4.5.1 or later. 
* R Studio version 2025.05.01 or later
* Download both from https://posit.co/download/rstudio-desktop/

Students who do not have a computer that they install programs on (i.e. a iPad or Chromebook) can use the [Wildcat virtual lab](https://support.csuchico.edu/TDClient/1984/Portal/KB/ArticleDet?ID=112333), or sign up for [Posit Cloud](https://posit.cloud). The free or $5/month plan should be sufficient.
...
You will get out of this class what you put into it. Recall this is just a co-curricular or supplemental basic introductory class. You will not learn everything there is to know about R, nor likely not feel proficient by the time you are done. But you will be solidly on the path where you can continue to learn and improve.
...
* Assignments are due after each week, see Canvas for due dates. <!--- Sunday by midnight. --->
* Assignment over 7 days late receive a one point deduction. 


## Submitting Assignments

Assignments are submitted to Canvas after rendering directly to PDF and graded using a rubric. You will learn how to create PDF's from your code during the first week. Submitting files not in the requested format will not be graded, but you can resubmit for full credit. 
<!--be marked down, but you can resubmit for full credit. -->


### Gradescope

Gradescope is a third party program that allows for an improved grading platform. You will submit your homework assignments in Canvas by clicking on a link that will take you to the appropriate location in Gradescope. You can log directly into Gradescope using your Chico State SSO login. 

Logging into Gradescope gives you the ability to see your comments and grading breakdown based on a rubric, and to request regrades to your assignments as necessary. Feedback and rubrics are not available in Canvas. 
...
Phone: 530-898-5959. Location: Student Services Center 170. Email: arcdept@csuchico.edu. Website: [http://www.csuchico.edu/arc](http://www.csuchico.edu/arc)
