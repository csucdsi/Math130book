...
# Syllabus {.unnumbered #sec-syllabus}
...
Assignments are submitted to Canvas after rendering directly to PDF and graded using a rubric. You will learn how to create PDF's from your code during the first week. Submitting files not in PDF format will be marked down, but you can resubmit for full credit. 
