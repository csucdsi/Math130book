...
[**Plot Enhancements** video](https://media.csuchico.edu/media/MATH+130+-+Section+9+Intro/1_bx7k3pcm)
...
[**Reorder barcharts in decreasing order** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.1/1_bjdbvhrf)
...
ggplot(pen, aes(
  x=species)) + 
  geom_bar() + xlab("Species - original sort")

ggplot(pen, aes(
  x=fct_infreq(species))) + 
  geom_bar() + xlab("Species - sorted by frequency")
```
## Flipping the axis

[**Flipping the axis** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.2/1_dthvw7xw)
...
[**A "better" Pie chart** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.3/1_lu2qv8ay)
...
[**Adding the mean** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.4/1_6713syok)
...
[**Histograms + density curve** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.5/1_7dvuog5f)
...
[**Adding violins to a boxplot** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.6/1_2kgijmom)
...
[**Themes** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.7/1_t7lqlbnh)
...
[**Legends (keys)** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.8/1_eulwhqtm)
...
[**Title and axis labels** videos](https://media.csuchico.edu/media/MATH+130+-+Section+9.9/1_20mnj5p8)


A good plot needs to stand alone and convey as much information as possible. `ggplot2` provides a single `labs` function that is very versatile and includes options for alt-text as well. See `?labs` for more information
...
[**Changing colors** videos](https://media.csuchico.edu/media/MATH+130+-+Section+9.10/1_74fq85lj)
...
[**Multivariate plotting** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.11/1_obqiszd4)
...
[**Faceting / paneling** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.12/1_sg8p0a8z)
...
[**Multiple plots per window** video](https://media.csuchico.edu/media/MATH+130+-+Section+9.13/1_ibj1at74)
