...
2. Right click and "save as" this lessons [[notes/dm_notes.qmd]](dm_notes.qmd) Quarto notes file and save into your `notes/Math130` folder. 
...
Sometimes we have a need to create or modify variables in a data frame. You will learn several ways to do this throughout this course, but we will start by using _base R_ functions and methods. These are methods that use functions that come with R, not from additional packages. 
