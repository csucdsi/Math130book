...
```{r}
#| layout-ncol: 2
ggdensity(dsmall, x="depth", color = "cut") # left
ggdensity(dsmall, x="depth", fill = "cut") # right
```
...
```{r}
#| layout-ncol: 2
ggplot(dsmall, aes(x=price, y=cut)) + geom_boxplot() # left
ggplot(dsmall, aes(x=cut, y=carat)) + geom_boxplot() # right
```
