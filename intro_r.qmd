...
[**Getting Started with R** video](https://media.csuchico.edu/media/MATH+130+-+Section+3+Intro/1_snpe6o76)
...
[**R as a calculator** video](https://media.csuchico.edu/media/MATH+130+-+Section+3.1/1_wb6brju3)

In the last lesson you saw how to do basic math in the console. Now try a more complicated expression. 
...
:::{.callout-tip title = "👉 Your Turn" icon=false}
Put an open parenthesis `(` before `log10` to fix it and try
again.
:::
...
This is because you have not 'closed' a parenthesis or quotation, i.e. you don't have the same number of left-parentheses as right-parentheses, or the same number of opening and closing quotation marks, or finished the expression before pressing enter.
...
[**Creating objects in R** video](https://media.csuchico.edu/media/MATH+130+-+Section+3.2/1_fznux8u9)
...
[**Functions and their arguments** video](https://media.csuchico.edu/media/MATH+130+-+Section+3.3/1_l105bgpb)
...
[**Data Types** video](https://media.csuchico.edu/media/MATH+130+-+Section+3.4/1_glptknjv)
...
[**Data Structures** video](https://media.csuchico.edu/media/MATH+130+-+Section+3.5/1_5n9oowpc)
...
[**Data Frames** video](https://media.csuchico.edu/media/MATH+130+-+Section+3.6/1_ph47ippc)
...
![_figure depicting a data frame_](img/data-frame.png)
...
![_screenshot of dataset in the global environment_](img/data.PNG)
