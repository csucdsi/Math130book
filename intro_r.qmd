...
$\LaTeX$ (pronounced "lay-tek" or "lah-tex"). It's a super neat program,
but also nearly 4Gb. Too big for our needs. That's where the `tinytex`
package came from. we're going to use it to install a lightweight
version of $\LaTeX$. This will let us write math equations in R
Markdown, and create PDF's of your homework.
