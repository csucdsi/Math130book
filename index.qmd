...
Math 130 is designed as a short-course "primer" to be taken before, or concurrently with, an upper division or graduate Statistics course such as Math 315 or Math 615. This can also be used a preparatory learning for classified admission into the [Masters in Data Science and Analytics Program](https://www.csuchico.edu/math/degrees/msdsa.shtml)[Want to Learn Python? <a href="https://roualdes.us/MATH131/intro.html">Check out Math 131 </a>]{.aside}
...
:::{.callout-tip title = "Details for Fall 2026" icon=false}
📄 &nbsp; [Syllabus](syllabus.pdf) \
📅 &nbsp; Section 01: in person MWF  9-9.50am in Holt 291, 08/24/26 - 09/25/26 \
📅 &nbsp; Section 02: fully asynchronous 08/24/26 - 09/25/26 \
🐾 &nbsp; Instructor: Edward A. Roualdes (call me Edward) \
🚪 &nbsp; Edward's Office Holt 204 \
📧 &nbsp; <a href="mailto:eroualdes@csuchico.edu">eroualdes@csuchico.edu</a> \
:::
